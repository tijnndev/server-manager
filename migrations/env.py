...
# Ensure the Flask app context is available when Alembic runs
def get_engine():
    with app.app_context():  # Push the app context for database access
        try:
...
# Set the SQLAlchemy URL for Alembic migration
